...
form.addEventListener('submit', e => {
  ...
  fetch(scriptURL, { method: 'POST', body: new FormData(form) })
    ...
    .then(response => {
      ...
      // Ambil nilai nomor surat dari element input
      const nomorSurat = document.getElementById("nomorSuratInput").value;
      // Tampilkan alert dengan spasi dan format yang rapi
      alert("Terimakasih, inputan Anda telah kami terima.\nNomor Surat Anda Adalah: " + nomorSurat);
      ...
      // Ambil kembali data nomor urut terbaru dari Google Sheets setelah submit berhasil
      ambilNomorTerbaru();
